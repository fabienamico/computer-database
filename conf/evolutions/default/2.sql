...
insert into computer (id,name,introduced,discontinued,company) values (  1,'MacBook Pro 15.4 inch',null,null,'Apple Inc.');
insert into computer (id,name,introduced,discontinued,company) values (  2,'CM-2a',null,null,'Thinking Machines');
insert into computer (id,name,introduced,discontinued,company) values (  3,'CM-200',null,null,'Thinking Machines');
insert into computer (id,name,introduced,discontinued,company) values (  4,'CM-5e',null,null,'Thinking Machines');
insert into computer (id,name,introduced,discontinued,company) values (  5,'CM-5','1991-01-01',null,'Thinking Machines');
insert into computer (id,name,introduced,discontinued,company) values (  6,'MacBook Pro','2006-01-10',null,'Apple Inc.');
insert into computer (id,name,introduced,discontinued,company) values (  7,'Apple IIe',null,null,null);
insert into computer (id,name,introduced,discontinued,company) values (  8,'Apple IIc',null,null,null);
insert into computer (id,name,introduced,discontinued,company) values (  9,'Apple IIGS',null,null,null);
insert into computer (id,name,introduced,discontinued,company) values ( 10,'Apple IIc Plus',null,null,null);
insert into computer (id,name,introduced,discontinued,company) values ( 11,'Apple II Plus',null,null,null);
insert into computer (id,name,introduced,discontinued,company) values ( 12,'Apple III','1980-05-01','1984-04-01','Apple Inc.');
